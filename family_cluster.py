...
sql = 'SELECT year,household_id,family_id,cell_phones FROM National_Center_for_Health_Statistics_Modeled.family'
...
# write PCollection to log file
formatted_Family | 'Write log 2' >> WriteToText(DIR_PATH + 'formatted_NOP_DF.txt')

dataset_id = 'National_Center_for_Health_Statistics_Modeled'
table_id = 'family_Beam_DF'
